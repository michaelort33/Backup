  ...
  function resetAnswerExplButton(newSlide){
  	if(document.getElementById("ans_expl"+newSlide).className=="hidden"){
    	ansButton.value="Show Answer Explanation";
    }else{
    	ansButton.value="Hide Answer Explanation";
    }
  }

  function showNextSlide() {
  	resetAnswerExplButton(currentSlide+1);
