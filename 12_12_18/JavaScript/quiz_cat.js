  ...
  (function() {
    function shuffle(multiArray) {
      ...
      // Create bucket of indices from 1 - length of array
      for(i=0;i<multiArray.length;i++){
        bucket.push(i);
      }
      //create copy of array that is shuffled
      for(i=0;i<multiArray.length;i++){
        randomNumber = Math.floor(Math.random() * bucket.length);
        randomIndex=bucket[randomNumber];
        //delete used incide from bucket array
        bucket.splice(randomNumber,1);
        //create new array with random indice of unshuffled array
        shuffledArray[i]=multiArray[randomIndex];
      }
